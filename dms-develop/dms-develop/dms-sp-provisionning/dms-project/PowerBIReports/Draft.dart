let
    ...
    // _DraftDocLibraryID = "250da639-87c5-4595-a573-adec480a8ff5",
    // _DraftContentTypeId = "0x0120D5200010BA2408052EEF418E580CFAEB67F31800EB3B62F71384A84FAC5CB28DC96512C8",
    ...
    DocumentLibrary = Source{[Id=_DraftDocLibraryID]}[Items],

    // Filter to include only document sets using the specific ContentTypeId
    FilterContentType = Table.SelectRows(DocumentLibrary, each [ContentTypeId] = _DraftContentTypeId),

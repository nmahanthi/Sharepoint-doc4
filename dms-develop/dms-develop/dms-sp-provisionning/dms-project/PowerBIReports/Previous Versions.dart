let
    ...
    // _PrevRevDocLibraryID = "0ea3d3bb-0acb-4025-9568-aa89529f7487",
    // _PrevRevDocSetContentTypeId = "0x0120D5200010BA2408052EEF418E580CFAEB67F3180080BDDE69CBAFBC459D23C134020F4F88",
    ...
    DocumentLibrary = Source{[Id=_PrevRevDocLibraryID]}[Items],

    // Filter to include only document sets using the specific ContentTypeId
    FilterContentType = Table.SelectRows(DocumentLibrary, each [ContentTypeId] = _PrevRevDocSetContentTypeId),
    FilteredItems = Table.SelectRows(FilterContentType, each [ServerRedirectedEmbedUri] = null),
    LatestRevision = Table.AddColumn(FilteredItems, "Latest Revision", each "No"),
